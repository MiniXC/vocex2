...
# python scripts/train.py --freeze_whisper=True --from_pretrained="checkpoints/small_frozen_align/latest" --wandb_mode=online --run_name "small_frozen_align_contd2k"